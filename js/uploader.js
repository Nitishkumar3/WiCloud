...
function vpb_multiple_file_uploader(vpb_configuration_settings)
{
	...
	var self = this;
	var vpb_msg = "Sorry, your browser does not support this application...";
		...
		if(typeof file[file_counter] != undefined && file[file_counter] != '')
		{
			...
			else
			{
				...
				$.ajax({
					...
					beforeSend: function() 
					{
						$("#uploading_"+ids).html('<div align="center"><img src="images/loadings.gif" width="80" align="absmiddle" title="Upload...."/></div>');
					...
					success:function(response) 
					{
						setTimeout(function() {
							...
							if ( response_brought != -1) {
								$("#uploading_"+ids).html('<div align="center" style="font-family:Verdana, Geneva, sans-serif;font-size:11px;color:blue;">Completed</div>');
								...
								if ( fileType_response_brought != -1) {
									...
									$("#uploading_"+fileID).html('<div align="center" style="font-family:Verdana, Geneva, sans-serif;font-size:11px;color:red;">Invalid File</div>');
									...
									if ( filesize_response_brought != -1) {
										...
										$("#uploading_"+fileID).html('<div align="center" style="font-family:Verdana, Geneva, sans-serif;font-size:11px;color:red;">Exceeded Size</div>');
										$("#remove"+fileID).html('<div align="center" style="font-family:Verdana, Geneva, sans-serif;font-size:11px;color:orange;">Cancelled</div>');
									} else {
